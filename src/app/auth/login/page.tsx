            ...
            <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
                ...
                {!showEmailForm ? (
                    ...
                    <div>
                        <button
                            ...
                            className={`flex items-center text-gray-600 hover:text-gray-800 mb-6 ${isRTL ? 'flex-row-reverse' : ''}`}
                        >
                        ...
                        <form onSubmit={handleEmailSignIn} className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                <label className={`flex items-center ${isRTL ? 'flex-row-reverse' : ''}`}>
                                    <input
                                        type="checkbox"
                                        className="rounded border-gray-300 text-black shadow-sm"
                                    />
                                    <span className={`text-sm text-gray-600 ${isRTL ? 'mr-2' : 'ml-2'}`}>{t('auth.rememberMe')}</span>
                                </label>

                                <Link href="/login/reset-password" className="text-sm text-blue-600 hover:text-black font-medium">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-black text-white py-3 px-4 rounded-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 transition-colors duration-200 font-medium"
                            >
                                {t('auth.login.button')}
                            </button>
                        </form>
                ...
                <div className="mt-6 text-center">
                    <p className="text-sm text-gray-600">
                        ...
                        <Link href="/sign" className="text-blue-600 hover:text-gray-800 font-medium">
